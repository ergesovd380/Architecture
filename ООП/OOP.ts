...
// class DatabaseAlone {
//   url: number;
//   private static instance: DatabaseAlone;                              // Мы добавляем еще одну свойству в класс. Оно будет static. (Static свойство говорит нам о том что, к нему можно обращаться без создание экземпляра класса. Подругому говоря, не нужно создовать объект для того чтобы работать с static методом или свойством)
